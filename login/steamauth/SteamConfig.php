...
include '../config.php';
//Version 3.2
$steamauth['apikey'] = $SteamWebAPIKey; // Your Steam WebAPI-Key found at https://steamcommunity.com/dev/apikey
$steamauth['domainname'] = $url; // The main URL of your website displayed in the login page
