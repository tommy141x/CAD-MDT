...
if ($_POST['callid']) {
    ...
    $callquery = $database->query("SELECT apparatus_call FROM mdt_apparatus WHERE id='".$aid."'");
    ...
    foreach ($arr11 as $key => $item) {
        if ($item["id"] == $aid) {
            if ($item["apparatus_call"] == $cid) {
                ...
                echo "
											<p id='togglex' class='mb-4' hidden> ".$item["apparatus_name"]." [".$item["apparatus_status"]."]</p>
											";
            }
            echo "
											<p id='toggley' class='mb-4' hidden>There are currently no units attached.</p>
										";
        } elseif ($item["apparatus_call"] == $cid) {
            echo "
									<p class='mb-4'> ".$item["apparatus_name"]." [".$item["apparatus_status"].$div."]</p>
									";
        }
    }
    ...
    if (($attached == true) and ($onlyUnitAttached == true)) {
        ...
        echo"
					...
					<input type='hidden' name='apparatus_id1' id='apparatus_id1' value=".$aid.">
					<input type='hidden' name='apparatus_call1' id='apparatus_call1' value='none'>
    ...
    if (($attached == true) and ($onlyUnitAttached == false)) {
        ...
        echo"
					...
					<input type='hidden' name='apparatus_id2' id='apparatus_id2' value=".$aid.">
					<input type='hidden' name='apparatus_call2' id='apparatus_call2' value='none'>
    ...
    if ($attachedOtherCall == true) {
        ...
        if (($attached == false) and ($noUnitsAttached == true)) {
            ...
            echo"
					...
					<input type='hidden' name='apparatus_id3' id='apparatus_id3' value=".$aid.">
					<input type='hidden' name='apparatus_call3' id='apparatus_call3' value='".$cid."'>
        ...
        if (($attached == false) and ($noUnitsAttached == false)) {
            ...
            echo"
					...
					<input type='hidden' name='apparatus_id4' id='apparatus_id4' value=".$aid.">
					<input type='hidden' name='apparatus_call4' id='apparatus_call4' value='".$cid."'>
    ...
    echo "
							...
							<input type='hidden' name='acall_id' id='acall_id' value='".$cid."'>
