...
if ($_SERVER["REQUEST_METHOD"] == "POST") {//Check it is coming from a form
    ...
    if ($queryresult == null) {
        $database->query("INSERT INTO mdt_units (steam_id, unit_callsign, unit_name, unit_status, unit_call, unit_division, unit_type, unit_panic)VALUES('".$steam_id."', '".str_replace("'", '', $callsign)."', '".str_replace("'", '', $name)."', '10-42', 'none', 'LEO', 'LEO', '0');");
